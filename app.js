...
function normalizeHttpUrl(value) {
  ...
  const candidate = /^https?:\/\//i.test(raw) || hasScheme ? raw : `https://${raw}`;
  try {
...
function createTodoLinkRow(link = {}) {
  ...
  urlInput.placeholder = 'https://example.com 或 www.example.com';
